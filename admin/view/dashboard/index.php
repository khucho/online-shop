	...
	<div class="container-fluid p-0">
		...
		<div class="row">
			<div class="col-xl-12 col-xxl-12">
				<div class="w-100">
					<div class="col-xl-12 col-xxl-12 d-flex order-2 order-xxl-3">
						...
						<table class="table table-hover my-0">
							...
							<tbody>
								...
								foreach ($reports as $report) {
									...
									echo "<td>" . date("F", mktime(0, 0, 0, $report['month'], 1)) . "</td>";
									echo "<td>" . $report['profit'] . "</td>";
									echo "</tr>";
								}
								?>
							</tbody>
