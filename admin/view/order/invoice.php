    ...
    <div class="container mt-5">
        <div class="row">
            <div class="invoice_design col-md-8 offset-md-2">
                ...
                <div class="row pb-3">
                    <div class="col-md-6">
                        <p><strong>Order Code: </strong><?php echo $code; ?></p>
                        <p><strong>Date: </strong><?php echo $orders[0]['date'] ?></p>
                    </div>
                    <div class="col-md-6">
                        <p><strong>Customer Name: </strong><?php echo $orders[0]['user_name'] ?></p>
                        <p><strong>Email: </strong><?php echo $orders[0]['user_email'] ?></p>
                    </div>
                </div>
